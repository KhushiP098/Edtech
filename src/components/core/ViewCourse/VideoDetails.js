...
const VideoDetails = () => {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      // if no of sections in the course Content is 0 then return
      ...
      if (!courseId && !sectionId && !subSectionId) {
        ...
        console.log("courseSectionData", courseSectionData)
         //it will contain section whose id is given in the params
        const filteredData = courseSectionData?.filter(
          (sec) => sec._id === sectionId
        )

        console.log("filteredData", filteredData) 
        // it will contain the subsection (lecture) whose id is given in the params
